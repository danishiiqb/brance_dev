...
function OrderItem({ item }) {
  return (
    <div className="flex border-b-[1.7px] last:border-b-[0px] py-7 first:pt-0 last:pb-0 ">
      ...
      <div className="w-72 ">
        ...
        <div className="flex space-x-3.5 text-[#777777] ">
          ...
          <div className="text-xs w-28 flex justify-between">
            ...
            <span>
              $
              {((Math.round(item.prize * 100) / 100) * item.orderedQty).toFixed(
                2
              )}
            </span>
          </div>
      ...
      <div className="flex-1 mr-16 ml-8 flex items-center">
        <div className="flex w-[33.33%] relative items-center">
          <div className="absolute font-medium text-[#FF385C]  text-xs bottom-[160%] -translate-x-1/2 ">
            Ordered
          </div>
          <div className="w-3 h-3 rounded-full bg-[#FF385C]"></div>
          <div className="bg-[#FF385C] w-full h-1 "></div>
        </div>
        <div className="flex w-[33.33%] relative items-center">
          <div className="absolute font-medium text-[#FF385C] text-xs bottom-[160%] -translate-x-1/2 ">
            Shipped
        ...
        <div className="flex relative w-[33.33%] items-center">
          ...
          <div className="bg-[#FF385C] w-full h-1 "></div>
          <div className="w-3 h-3 rounded-full bg-[#FF385C]"></div>
          <div className="absolute font-medium text-[#FF385C] text-xs bottom-[160%] -translate-x-1/2 left-full ">
            Delivered
          </div>
        </div>
      </div>
      <div className=" self-center  space-y-2 ">
        <div className="font-medium  transition-all duration-200  cursor-pointer hover:text-[#FF385C]  items-center space-x-1 flex text-xs">
          <div>
            <GoStar />
          </div>
